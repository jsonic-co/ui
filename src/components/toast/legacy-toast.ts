...
import { toast as sonner } from "@jsonic-co/vue-sonner"
...
/**
 * @deprecated LegacyToast is deprecated and will be removed in a future version. Not recommended for use. Instead import toast from '@jsonic-co/ui' and use 'toast.show()'
 */
const legacyToast = {
