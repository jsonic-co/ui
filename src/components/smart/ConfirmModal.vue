...
import { JsonicButtonPrimary, JsonicButtonSecondary } from "../button"
import { JsonicSmartModal } from "."
import { JsonicUIPluginOptions, JSONIC_UI_OPTIONS } from "./../../plugin"

const { t } = inject<JsonicUIPluginOptions>(JSONIC_UI_OPTIONS) ?? {}
