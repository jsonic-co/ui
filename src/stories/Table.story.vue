<template>
  <Story title="Table">
    ...
    <Variant title="Custom">
      ...
      <JsonicSmartTable :loading="loading" :list="list">
        <template #head>
          <th
...
import { JsonicButtonPrimary, JsonicSmartInput } from ".."
import { JsonicSmartSpinner, JsonicSmartTable } from "../components/smart"
